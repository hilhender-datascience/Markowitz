---
title: "P4: Teoria Moderna de Portifolio de Markowitz e VaR"
author: "Raphael Marques Franco"
date: "`r Sys.Date()`"
output: 
 html_document:
    toc: true                    # Tabela de conteúdo
    toc_float: true              # TOC que flutua ao lado
    toc_depth: 3                 # Profundidade até nível 3
    number_sections: true        # Numerar seções automaticamente
    theme: cosmo                 # Tema limpo e profissional
    highlight: tango             # Destaque de código
    code_folding: hide           # Esconder código inicialmente
    fig_caption: true            # Legendas nas figuras
